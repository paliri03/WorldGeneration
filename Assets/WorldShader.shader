...
Shader "WorldShader" 
{
    ...
    SubShader 
    {
        ...
        void surf (Input IN, inout SurfaceOutput o) 
        {
            ...
            float isUp = abs(IN.worldNormal.y); // юудет работать только пока нормаль равна точно 0 или 1

            float2 offset = float2(my_fmod(z + x * (1 - isUp), 0.0625), my_fmod(y + x * isUp, 0.0625));//0.0625 = 128/2048 
