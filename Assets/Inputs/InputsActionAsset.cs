...
//     version 1.4.4
//     from Assets/Inputs/InputsActionAsset.inputactions
//
...
public partial class @InputsActionAsset : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputsActionAsset()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputsActionAsset"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputsActionAsset m_Wrapper;
        public PlayerActions(@InputsActionAsset wrapper) { m_Wrapper = wrapper; }
